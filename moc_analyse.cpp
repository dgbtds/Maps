...
QT_MOC_LITERAL(1, 8, 6), // "prompt"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 5) // "title"

    },
    "Analyse\0prompt\0\0title"
};
...
void Analyse::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Analyse *_t = static_cast<Analyse *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (Analyse::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Analyse::prompt)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Analyse::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Analyse.data,
      qt_meta_data_Analyse,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Analyse::prompt(QString _t1)
{
